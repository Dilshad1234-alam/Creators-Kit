    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto prose prose-invert">
        ...
        <div className="space-y-6 text-zinc-400 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-zinc-100 mt-8 mb-4">Returns</h2>
          ...
          <h2 className="text-2xl font-bold text-zinc-100 mt-8 mb-4">Refunds</h2>
          ...
          <h2 className="text-2xl font-bold text-zinc-100 mt-8 mb-4">Shipping Returns</h2>
