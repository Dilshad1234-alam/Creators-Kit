      ...
      <div className="w-full px-6 md:px-12 lg:px-24 mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="flex items-center gap-4 text-white">
            {/* Social Icons (Mock) */}
            <a href="https://instagram.com/creatorskithub" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-zinc-900 flex items-center justify-center hover:bg-[#FF3B14] transition-colors border border-zinc-800 hover:border-transparent">
        ...
        <div>
          ...
          <ul className="space-y-4 text-base font-medium">
            <li><Link href="/" className="hover:text-[#FF3B14] transition-colors">Home</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-4 text-base font-medium">
            <li><Link href="/legal/terms" className="hover:text-[#FF3B14] transition-colors">Terms of Service</Link></li>
            <li><Link href="/legal/privacy" className="hover:text-[#FF3B14] transition-colors">Privacy Policy</Link></li>
            <li><Link href="/legal/shipping" className="hover:text-[#FF3B14] transition-colors">Shipping Policy</Link></li>
            <li><Link href="/legal/returns" className="hover:text-[#FF3B14] transition-colors">Return Policy</Link></li>
          </ul>
        </div>
      </div>
