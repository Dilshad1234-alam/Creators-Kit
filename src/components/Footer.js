...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-background text-neutral-400 py-20 border-t border-neutral-800 font-sans">
      <div className="w-full px-6 md:px-12 lg:px-24 mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <p className="text-lg max-w-md font-medium leading-relaxed text-neutral-400 mb-8">
          ...
          <div className="flex items-center gap-4 text-neutral-100">
            {/* Social Icons (Mock) */}
            <a href="https://instagram.com/creatorskithub" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-neutral-900 flex items-center justify-center hover:bg-primary transition-colors border border-neutral-800 hover:border-transparent">
        ...
        {/* Quick Links */}
        <div>
          <h4 className="text-neutral-100 font-bold text-xl mb-6">Company</h4>
        ...
        {/* Legal Links */}
        <div>
          <h4 className="text-neutral-100 font-bold text-xl mb-6">Legal</h4>
          <ul className="space-y-4 text-base font-medium">
      ...
      <div className="w-full px-6 md:px-12 lg:px-24 mt-20 pt-10 border-t border-neutral-800 text-base text-center font-medium">
