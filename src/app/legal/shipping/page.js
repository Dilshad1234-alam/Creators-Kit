    ...
    <div className="min-h-screen bg-background text-neutral-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto prose prose-invert">
        ...
        <div className="space-y-6 text-neutral-400 leading-relaxed">
          <h2 className="text-2xl font-bold text-neutral-100 mt-8 mb-4">Processing Time</h2>
          ...
          <h2 className="text-2xl font-bold text-neutral-100 mt-8 mb-4">Domestic Shipping Rates and Estimates</h2>
          ...
          <h2 className="text-2xl font-bold text-neutral-100 mt-8 mb-4">International Shipping</h2>
          ...
          <h2 className="text-2xl font-bold text-neutral-100 mt-8 mb-4">How do I check the status of my order?</h2>
