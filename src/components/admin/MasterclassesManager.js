...
export default function MasterclassesManager() {
  ...
  if (loading) return <div className="text-neutral-400 mt-8">Loading Mastery Courses...</div>;

  return (
    <>
      <div className="bg-neutral-900/60 border border-neutral-800/80 shadow-2xl rounded-3xl p-8 backdrop-blur-xl mt-12">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl font-bold text-neutral-100">Manage Masterclasses / Mastery Courses</h2>
          <button 
