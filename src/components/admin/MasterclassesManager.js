...
export default function MasterclassesManager() {
  ...
  if (loading) return <div className="text-neutral-600 dark:text-neutral-400 mt-8">Loading Mastery Courses...</div>;
    ...
    <>
      <div className="bg-white dark:bg-neutral-900/60 border border-neutral-200 dark:border-neutral-800/80 shadow-2xl rounded-3xl p-8 backdrop-blur-xl mt-12">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 md:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-neutral-100">Manage Masterclasses / Mastery Courses</h2>
          <button 
                ...
                <tr key={item._id} className="hover:bg-neutral-100 dark:bg-neutral-800/20 transition-colors">
                  ...
                  <td className="py-5 pr-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-bold text-neutral-900 dark:text-neutral-100">{item.title}</span>
                    </div>
                  </td>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
              <div className="px-8 py-6 space-y-4 overflow-y-auto custom-scrollbar flex-1">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-neutral-500 mb-1 uppercase tracking-wider">Course Title</label>
                    <input 
                      required 
                      type="text" 
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-bold text-neutral-500 mb-1 uppercase tracking-wider">Badge Text</label>
                    <input 
                      type="text" 
