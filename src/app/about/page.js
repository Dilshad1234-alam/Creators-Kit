export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-zinc-100 w-full font-sans overflow-hidden">
      
      {/* Hero Section */}
      <section className="relative w-full pt-24 pb-32 bg-[#0d0d0d]">
        ...
        <div className="w-full px-6 md:px-12 lg:px-24 relative z-10 text-center flex flex-col items-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-#FF6B4A/10 text-#FF6B4A text-xs font-bold mb-8 border border-#FF6B4A/20 shadow-sm">
      ...
      <section className="w-full py-24 bg-zinc-900 text-zinc-100 relative">
        ...
        <div className="w-full px-6 md:px-12 lg:px-24 mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div>
            ...
            <div className="w-20 h-2 bg-[#FF3B14] mb-8 rounded-full"></div>
          ...
          <div className="bg-[#0d0d0d]/50 backdrop-blur-xl p-10 md:p-12 rounded-[3rem] border border-zinc-800 shadow-2xl relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#FF3B14]/10 rounded-full blur-[80px] group-hover:bg-[#FF3B14]/20 transition-colors duration-700"></div>
      ...
      <section className="w-full py-32 bg-[#0d0d0d] border-t border-zinc-900">
        <div className="w-full px-6 md:px-12 lg:px-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            {/* Equipment */}
            <div className="bg-zinc-900 p-10 lg:p-12 rounded-[3rem] shadow-sm hover:shadow-2xl hover:shadow-#FF6B4A/10 border border-zinc-800 hover:border-[#FF3B14]/50 transition-all duration-300 group flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-[#0d0d0d] rounded-full flex items-center justify-center text-5xl mb-8 shadow-md border border-zinc-800 group-hover:-translate-y-2 group-hover:scale-110 transition-transform duration-300">
                🎥
              </div>
