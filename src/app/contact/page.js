    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 max-w-5xl mx-auto bg-zinc-900 rounded-3xl shadow-sm border border-zinc-800 overflow-hidden">
          ...
          {/* Contact Info */}
          <div className="bg-zinc-950 text-zinc-100 p-10 md:p-16 flex flex-col justify-between border-r border-zinc-800">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 bg-[#FC1D00]/20 rounded-full flex items-center justify-center text-[#FC1D00]">
            ...
            <div className="mt-12">
              <span className="text-2xl font-black tracking-tighter text-[#FC1D00]">Creators Kit</span>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  id="name"
                  required
                  className="w-full px-4 py-3 rounded-xl bg-zinc-950 border border-zinc-700 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#FC1D00]"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="4"
                  className="w-full px-4 py-3 rounded-xl bg-zinc-950 border border-zinc-700 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#FC1D00] resize-none"
                  placeholder="How can we help you?"
                ></textarea>
              </div>
              <button
                type="submit"
                className="w-full py-4 bg-[#FC1D00] text-white rounded-xl font-bold text-lg hover:bg-[#E01900] transition-colors shadow-md"
              >
                Send Message
              </button>
            </form>
