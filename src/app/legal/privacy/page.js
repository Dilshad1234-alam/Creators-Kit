    ...
    <div className="min-h-screen bg-white dark:bg-background text-neutral-900 dark:text-neutral-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto prose prose-invert">
        ...
        <div className="space-y-6 text-neutral-600 dark:text-neutral-400 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mt-8 mb-4">Information We Collect</h2>
          ...
          <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mt-8 mb-4">How We Use Your Information</h2>
          <p>We use the Order Information that we collect generally to fulfill any orders placed through the Site (including processing your payment information, arranging for shipping, and providing you with invoices and/or order confirmations).</p>
          
          <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mt-8 mb-4">Sharing Your Information</h2>
