    ...
    <div className="min-h-screen bg-white dark:bg-background pt-32 pb-24">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-full bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center font-bold text-xl text-neutral-700 dark:text-neutral-300 border border-neutral-700">
            {blog.author.charAt(0)}
          </div>
          <div>
            <p className="text-neutral-900 dark:text-white font-bold">{blog.author}</p>
        ...
        <div className="premium-glow-card p-8 sm:p-12 rounded-[2rem]">
          <div 
            className="prose prose-invert prose-lg prose-neutral max-w-none 
              ...
              prose-blockquote:border-primary prose-blockquote:bg-primary/5 prose-blockquote:p-4 prose-blockquote:rounded-r-xl prose-blockquote:text-neutral-700 dark:text-neutral-300 prose-blockquote:font-medium prose-blockquote:not-italic"
